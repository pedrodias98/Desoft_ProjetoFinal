...
################################ 4 andar ########################################################
saida = pygame.image.load('saida.jpg') #retirar depois de ter o tutorial
...
def andar4(estado,visão):
    ...
    elif estado == 6: # (7.3)   #### SALA 10 VIEWS
       visão = 0
       while visão >= 0: 
            if visão == 0:
                gameDisplay.fill(white)
                ...
                if 390 <= X <= 480 and 478 <= Y <= 531:
                    ...
                    visão = 1 # frente (v6)    ####### SALA 10 VIEWS FINAL
